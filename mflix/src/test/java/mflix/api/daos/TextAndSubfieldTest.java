...
public class TextAndSubfieldTest extends TicketTest {
    ...
    public void testTextSearch() {
        ...
        Assert.assertEquals("Movie title does not match expected. Check your sort", "The Dress", firstMovie.getString("title"));
        ...
        Assert.assertEquals("The expect number of movies does not match. Check your query filter", limit, actualMoviesCount);
    }
    ...
    public void testTextSearchCount() {
        ...
        Assert.assertEquals("Text search matched documents does not match. Check your query filter", expected, dao.getTextSearchCount(keywords));
    }
    ...
    public void testSearchByCast() {
        ...
        Assert.assertEquals("Expected title does not match. Check your query filter", "Racing Extinction", movie.getString("title"));
        ...
        Assert.assertEquals("The expect number of documents does not match. Check your query filter", expectedCount, actualCount);
    }
    ...
    public void testSearchMultipleCast() {
        ...
        Assert.assertEquals("Number of movies expected does not match. Check your query filter", 33, numMovies);
        Assert.assertEquals("Total count of movies with cast does not match. Check your query filter", 75, dao.getCastSearchCount(cast.toArray(new String[0])));
    }
    ...
    public void testGenreSearch() {
        ...
        assertTrue("getMoviesByGenre should be returning documents", numMovies > 0);
        assertEquals("Number of total documents does not match expected. Check your dataset", 5917, dao.getGenresSearchCount(genre));
    }
}