...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            // Ticket: Migration - define the UpdateOneModel object for the rating type cleanup.
            return new UpdateOneModel<>(new Document("_id", doc.getObjectId("_id")), new Document("$set", new Document("imdb.rating", rating)));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix-t6snw.mongodb.net";
        ...
        // Ticket: Migration - create a query filter that finds all documents that are required to be updated and the correct date
        // format pattern
        ...
        // Ticket: Migration - create a query filter that finds documents where `imdb.rating` is of type string
